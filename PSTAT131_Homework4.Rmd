...
Choose Logistic; slightly higher mean accuracy (by 0.01), but lower standard error by 0.004. LDA is within one SE of logistic so we could go either way. however, by rule of thumb (based on what professor said in office hours), if we can choose the simpler model, we should.
